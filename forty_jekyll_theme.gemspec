...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = "https://andrewbanchich.github.io/"
  spec.license       = "MIT"

  spec.files         = `git ls-files -z`.split("\x0").select { |f| f.match(%r{^(itsme/assets|_layouts|_includes|_sass|LICENSE|README)}i) }
